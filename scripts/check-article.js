...
// ── стилевые запреты ────────────────────────────────────────────────
// Тире заданы кодами, а не символами, НАМЕРЕННО. 04.09.2026 чистка длинных
// тире по всему репозиторию прошла и по этой строке: символы «—» и «–»
// внутри регулярки превратились в два дефиса, класс стал [--], и
// проверка начала считать запрещённым обычный дефис - валила любую
// статью, включая уже опубликованные (75 «тире» в тексте без единого
// тире). Нашёл агент 05.09.2026. Коды чистка не тронет.
