...
- Нужен рекламный ролик, продуктовое видео или контент для соцсетей, сделанный
  генеративным AI (Kling, Seedance, Veo, MiniMax, Nano Banana) с реальной режиссурой.
...
- Вопрос «как пользоваться/оплатить Kling, Seedance, MiniMax, HeyGen, Nano Banana
...
Машиночитаемый прайс со всеми услугами, сроками и тем, от чего зависит цена:
${SITE}/pricing.md

Ориентиры: оживить фото 10 000 руб., AI-ролик 20-30 секунд от 50 000 руб.,
ролик до минуты от 100 000 руб., пакет из 10 вертикальных роликов от 120 000 руб.,
аудит процессов 25 000 руб., AI-ассистент для заявок от 150 000 руб.,
консультация и занятие по AI-видео 15 000 руб.
