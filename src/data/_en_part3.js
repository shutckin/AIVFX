...
const PART_3 = [
  {
    ...
    content: [
      ...
      { type: 'p', text: '**Google subscriptions:** after the tiers were rebuilt in May 2026 the lineup looks like this: **Google AI Plus** at about $7.99 per month, **Google AI Pro** at about $19.99 with access to the fast version of the model (Veo 3.1 Fast), **Google AI Ultra** at about $99.99, and a top tier with the highest limits at about $200. Google is also moving away from daily caps toward billing by actual usage. For regular commercial production you usually need Ultra specifically.' },
      { type: 'p', text: '**Payment via API (Vertex AI):** it is billed per second of finished video. After the price cuts the full model runs roughly **$0.20-0.40 per second**, the fast mode about **$0.10-0.15**, and the lightweight Veo 3.1 Lite from **$0.03**. That means an 8-second voiced clip on the full model costs around two to three dollars. It is still not cheap if you generate blindly, so in the studio we always work out a scene first on cheap draft modes and only run full 4K with sound on the final, approved takes.' },
      { type: 'p', text: 'There is also a lighter option - Veo 3.1 Lite at about $0.03 per second in 720p without sound. It is meant for bulk draft generation where quality is not critical.' },
      ...
      { type: 'p', text: '**Runway (Gen-4.5)** starts at roughly $12 per month and runs on a credit system with predictable usage for active users. It outputs native 1080p and can upscale to 4K. One generation runs 2 to 10 seconds, and an extension takes a scene to roughly eighteen. On the independent Video Arena ranking, where people blind-compare clips, Runway often holds first place by "like / dislike." It is strong as a universal creative tool with a rich set of controls.' },
      { type: 'p', text: 'One thing is especially important: **OpenAI\'s Sora is closed** - the site and the app were switched off on April 26, 2026, and the API ends on September 24. Despite its loud name, betting on it for production is no longer an option; the working trio is Veo, Kling, and Runway.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Important news for those who follow the market: **OpenAI\'s Sora is closed** - the site and the app were switched off on April 26, 2026, and the API ends on September 24, so we no longer count on it. The market leaders are different now, and each has its own strength. You do not need to buy subscriptions to everything - assemble a stack to match your task.' },
      ...
      { type: 'ol', items: [
        ...
        'Runway Gen-4.5 - the choice for advertising and client work that needs tight control. The best object stability between frames, the Motion Brush tools, character preservation, and since spring 2026 sound generated together with the picture. It is the most "production-friendly" engine.',
      ...
      { type: 'p', text: '**For sound:** ElevenLabs - voiceover and narration in Russian, with quality practically indistinguishable from a real announcer, plus voice cloning. For music, pick a generator with a clear license and read the terms of the plan you are actually on: Suno is still in court with the music labels, and for client advertising that is an unnecessary risk.' },
